...
func printUsage() {
	...
	fmt.Println("  snablr scan --targets 172.16.0.90 --username USER --password PASS")
	...
	fmt.Println("  snablr rules test --rule configs/rules/default/content.yml --input sample.conf --verbose")
...
func printDiscoverUsage(fs *flag.FlagSet) {
	...
	fmt.Println("  snablr discover --targets fs01,fs02 --skip-reachability-check")
