...
func Run(ctx context.Context, cfg Config) (Report, error) {
	...
	engine := scanner.NewEngine(scanner.Options{
		...
		WIM: wiminspect.Options{
			...
			MaxBinaryArtifacts: resolved.WIM.MaxBinaryArtifacts,
			MaxBinaryBytes:     resolved.WIM.MaxBinaryBytes,
			MaxSAMBytes:        resolved.WIM.MaxSAMBytes,
			MaxSYSTEMBytes:     resolved.WIM.MaxSYSTEMBytes,
			MaxSECURITYBytes:   resolved.WIM.MaxSECURITYBytes,
			MaxNTDSBytes:       resolved.WIM.MaxNTDSBytes,
			MaxImages:          resolved.WIM.MaxImages,
		},
